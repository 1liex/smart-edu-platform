...
$userQuery = $conn->prepare("SELECT id, name, email, role FROM users WHERE email = ?");
...
// ✅ 4. جلب جميع المعلمين وملفاتهم والكلمات والمصادر
$teachers = [];
...
// ✅ 5. هيكلة البيانات في شكل JSON
$teacherMap = [];

while ($row = $result->fetch_assoc()) {
    $t_id = $row['teacher_id'];

    // لو المعلم غير موجود نضيفه
